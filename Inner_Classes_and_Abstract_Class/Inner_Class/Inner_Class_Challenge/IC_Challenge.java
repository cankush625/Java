...
public class IC_Challenge {
    private static Scanner scanner = new Scanner(System.in);
    private static ArrayList<IC_Album> albums = new ArrayList<>();

    public static void main(String[] args) {
        IC_Album album = new IC_Album("a", "abc");
        ...
        LinkedList<IC_Song> playList = new LinkedList<>();
    ...
    private static void play(LinkedList<IC_Song> playList) {
        boolean quit = false;
        boolean forward = true;
        ListIterator<IC_Song> listIterator = playList.listIterator();
        if (playList.size() == 0) {
    ...
    private static void printList(LinkedList<IC_Song> playList) {
        Iterator<IC_Song> iterator = playList.iterator();
        System.out.println("========================");
